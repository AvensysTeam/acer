...
class LanguageController extends Controller
{
    ...
    { 
        ...
        $check = $request->validate([
            ...
            'country_flag' => ['required', 'mimes:png'],
            'is_default' => ['required'],
        ]);
        // dd($check);
        ...
        $country_flag=$request->country_flag->getClientOriginalName();
        $language->country_flag=$country_flag;
        $request->country_flag->move('img/country-flag',$country_flag);
        $language->save();
    ...
    {  
        ...
        $language->name = $request->name;
        $language->code = $request->code;
        $language->country_flag = $language->country_flag;
