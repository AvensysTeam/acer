                        ...
                        <table class="display compact project-table datatable-customer">
                            ...
                            if(isset($company_list)) {
                                ...
                                <tr data-id="{{ $company->id }}">
                                    ...
                                    <td class="nowrap act_btn" style="width:200px; height:35px; display: inline-block;">
                                        <a href="#!"
                                        ...
                                        <a href="#!" onclick="newContact()"><img class="new"
                                                src="{{ asset('assets/icons/users-add-profile-avatar-user-account-svgrepo-com.svg') }}" width="25px"
                                                /></a>
                                        <a href="{{ url('admin/projects/get/contactlist', $company->id) }}"><i
                                                class="fa-fw fas fa-users" style="font-size:22px; color:#818181; margin-top:2px;"></i></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="company_name" class="text-xs">@lang('company name')</label>
                            <input type="text" id="company_name" name="company_name" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="company_address" class="text-xs">@lang('Address')</label>
                            <input type="text" id="company_address" name="company_address" value="address"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="company_phone" class="text-xs">@lang('office telephone no')</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                            onclick="saveCompany()">@lang('Save')</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">@lang('Close')</button>
                        <button type="button" class="btn btn-primary"
                            onclick="saveContact()">@lang('Save')</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    @section('scripts')
        ...
        <script>
            ...
            function editCompany(cid, companydetail) {
                //var company_id = $(table2.row({selected: true}).node()).data('id');
                // alert(cid);
                //var company_id = cid;
                // if(company_id === undefined) {
                ...
                //var company_data = table2.row({selected: true}).data();            
            ...
            function saveCompany() {
                ...
                $.ajax({
                    ...
                    $('.modal').modal('hide');
                    let data = [postData.company_name, postData.company_address, postData.company_phone, postData
                        .company_VAT, postData.company_desc
                    ];
                    if (postData.company_id > 0) {
                        //table1.row({selected:true}).data(data).draw(false);
                        location.reload();
                    } else {
                        var new_tr = $('<tr data-id="' + res.result.id + '">' + data.map((item) => '<td>' + item +
                            '</td>').join("") + '<tr>');
