                    ...
                    <table class="display compact project-table datatable-customer">
                        ...
                        <tbody>
                            ...
                            <tr data-id="{{$company->id}}">
                                ...
                                <td class="nowrap">{{$company->description}}</td>
                                <td class="nowrap">
                                   <a href="#!" onclick="editCompany('{{$company->id}}','<?php echo $companydetail; ?>')"><img class="new mb-2" src="{{asset('assets/icons/pencil-line-icon-original.svg')}}" width="25px" height="25px"/></a>
                                   <a href="#!"onclick="deleteCompany('{{$company->id}}')"><img class="new mb-2" src="{{asset('assets/icons/trash-icon-original.svg')}}" width="25px" height="25px"/></a>
                                   <a href="#!" onclick="newContact()"><img class="new mb-2" src="{{asset('assets/icons/add-contact.png')}}" width="30px" height="30px"/></a>
                                   <a href="{{ url('admin/projects/get/contactlist',$company->id)}}" ><i class="fa-fw fas fa-users" style="font-size:22px; color:#818181;"></i></a>
